		...
		fields: [
			{
				...
				description: __("This will appear at the end of your page titles (e.g., Home | My Awesome Company)."),
				reqd: 1
			},
			{
			...
			},
			{
				...
				fieldtype: "Check",
				default: 1,
				description: __("Automatically generate meta descriptions and social tags for new pages.")
			},
			{
				...
				fieldtype: "Check",
				default: 1,
				description: __("Add JSON-LD structured data to help search engines understand your content.")
			}
		],
